        ...
        <div class="card" style="margin-bottom:20px">
          ...
          <div style="padding:20px">
            ...
            <div class="order-monitor-grid" id="antrian-grid">
              <div class="loading">
                <div class="spinner"></div> Memuat antrian pesanan...
              </div>
            </div>
          </div>
        </div>
            ...
            <div class="card">
              ...
              <div id="menu-grid" class="menu-grid">
                <div class="loading" style="grid-column:1/-1">
                  <div class="spinner"></div> Memuat menu...
                </div>
              </div>
            </div>
              ...
              <div class="table-wrap">
                <table>
                  ...
                  <tbody id="tbl-pesanan-aktif">
                    <tr>
                      <td colspan="5" class="text-center text-muted" style="padding:20px">Memuat...</td>
                    </tr>
                  </tbody>
                </table>
              </div>
          ...
          <div class="table-wrap">
            <table>
              ...
              <tbody id="tbl-laporan">
                <tr>
                  <td colspan="6" class="text-center text-muted" style="padding:24px">Pilih periode lalu klik "Tampilkan Laporan"</td>
                </tr>
              </tbody>
            </table>
          </div>
